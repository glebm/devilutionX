...
if(NOT DEFINED DEVILUTIONX_SYSTEM_NANOFLANN)
  find_package(nanoflann QUIET)
  if(nanoflann_FOUND)
    message("-- Found nanoflann ${nanoflann_VERSION}")
  else()
    message("-- Suitable system nanoflann package not found, will use nanoflann from source")
    set(DEVILUTIONX_SYSTEM_NANOFLANN OFF)
  endif()
endif()
dependency_options("nanoflann" DEVILUTIONX_SYSTEM_NANOFLANN ON DEVILUTIONX_STATIC_NANOFLANN)
if(DEVILUTIONX_SYSTEM_NANOFLANN)
