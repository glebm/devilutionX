...
This OpenDingux build uses the buildroot at `$HOME/buildroot-2014.08-rg350`.
...
This OpenDingux build uses the buildroot at `$HOME/buildroot-2018.02.9-opendingux-musl`.

~~~ bash
Packaging/OpenDingux/build-rs90-sdl1.sh
~~~
